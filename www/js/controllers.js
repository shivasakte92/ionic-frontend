...
.controller('checkoutCtrl', function($scope,$rootScope,sharedUtils,$state,$firebaseArray,
    ...
    $scope.pay=function(address,payment){
      ...
      if(address==null || payment==null){
        ...
        $state.go('testing', {}, {location: "replace", reload: true});
      }
    }
...
.controller('wineCtrl', function($scope,$rootScope) {

    $rootScope.extras=true;

})

.controller('beersCtrl', function($scope,$rootScope) {

    $rootScope.extras=true;

})

.controller('tobaccoCtrl', function($scope,$rootScope) {

    $rootScope.extras=true;

})

.controller('accessoriesCtrl', function($scope,$rootScope) {

    $rootScope.extras=true;

})

.controller('othersCtrl', function($scope,$rootScope) {
